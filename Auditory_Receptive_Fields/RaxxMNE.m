...
outdir = 'C:\Users\User\Desktop\FYP\MNE_SparsyBand';
...
%     % Check if MNE_model.mat already exists
    ...
    savename=fullfile(outdir,[name,'_MNE_SPARSE_YO.mat']);
...
%     end
    ...
    % Preprocess
    [training_set_usv, test_set_usv] = preprocess_spkdata(sparseMatrix,spikes.spkdata, current_parameters);
    % Run MNE
    ...
    if nsets>1
        ...
        [training_set_starling, test_set_starling] = preprocess_spkdata(sparseMatrix, spikes.spkdata, current_parameters);
